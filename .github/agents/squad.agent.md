...
| --- | --- | --- | --- |
| Lead | Lead | review | Architecture, work decomposition, cross-layer integration |
| Frontend | Frontend Dev | advisory | React components, client state, responsive and accessible UI |
| Backend | Backend Dev | advisory | Node.js APIs, validation, persistence, error handling |
| Tester | Tester | review | Unit, integration, and end-to-end testing, edge-case analysis |
| Infra | DevOps/Infra | edit | Local developer workflows, CI, environment configuration, deployment |
...
Lead, Frontend Dev, Backend Dev, Tester, DevOps/Infra, RAI Reviewer, Fact Checker
...
- **Can:** review code and pull requests; write and modify code; write and run tests; write and maintain documentation; security and secrets review; responsible-AI and content-safety review; author and maintain CI/CD workflows; deploy to live environments
- **Cannot (no agent claims this):** cut releases and publish packages; UX and visual design
